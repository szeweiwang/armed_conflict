...
data_maternal <- read.csv("original/maternalmortality.csv", header = TRUE)
data_infant <- read.csv("original/infantmortality.csv", header = TRUE)
data_neonatal <- read.csv("original/neonatalmortality.csv", header = TRUE)
data_under5 <- read.csv("original/under5mortality.csv", header = TRUE)
